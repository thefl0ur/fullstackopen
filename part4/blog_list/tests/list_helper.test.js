...
describe('total likes', () => {
  ...
  test('when list has many blogs, equals the summ their likes', () => { 
...
describe('favorite blog', () => {
  test('when list has only one blog, this blog is favorite', () => {
    const blog = blogs[0]
    const result = listHelper.favoriteBlog([blog])
    assert.deepStrictEqual(result, blog)
  })

  test('when list has many blogs, search for blog with most likes', () => { 
